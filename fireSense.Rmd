...
----|:-------|---------------------------------------------------------------------
`mapping`|`NULL`|optional named vector or list of character strings mapping the names of data objects required by the module to those in the `simList` environment.
